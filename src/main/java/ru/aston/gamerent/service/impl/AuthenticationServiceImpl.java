...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Override
    public AuthenticationUserDto findByEmailAndPassword(AuthenticationRequestDto authenticationRequestDto) {
        return userRepository.findByEmail(authenticationRequestDto.email())
                .filter(user -> passwordEncoder.matches(authenticationRequestDto.password(), user.getPassword()))
